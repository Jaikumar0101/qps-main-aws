...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        ...
        'livewire'=>[
            ...
            \App\Http\Middleware\Security\HttpRedirect::class,
        ],
    ...
    protected $routeMiddleware = [
        ...
        'ApiAdminAuthCheck'=>\App\Http\Middleware\ApiAdminAuthCheck::class,
        'AdminAuthRedirect'=>\App\Http\Middleware\AdminAuthRedirect::class,
        'AdminAuthCheck'=>\App\Http\Middleware\AdminAuthCheck::class,

        'UserAuthRedirect'=>\App\Http\Middleware\UserAuthRedirect::class,
