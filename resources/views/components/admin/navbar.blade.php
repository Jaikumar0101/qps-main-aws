    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="{{ route('admin::dashboard') }}" class="d-lg-none">
                <img alt="Logo" src="{{ asset(config('settings.site_mobile_logo')) }}" class="h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-md-4 d-none">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" id="kt_menu_notifications">
                        <!--begin::Heading-->
                        <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url({{ asset('assets/backend/assets/media/misc/menu-header-bg.jpg') }})">
                            <!--begin::Title-->
...
{{--                                <span class="fs-8 opacity-75 ps-3">24 reports</span>--}}
                ...
                <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img src="{{ auth()->user()->avatarUrl() }}" class="rounded-3" alt="user" />
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">{{ auth()->user()->fullName() }}
                                        <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{ auth()->user()->roleName() ??auth()->user()->userType() }}</span></div>
                        ...
                        <div class="menu-item px-5">
                            <a href="{{ route('admin::profile') }}" wire:navigate class="menu-link px-5">My Profile</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu separator-->
                        <div class="separator my-2"></div>
...
{{--												<img class="w-15px h-15px rounded-1 ms-2" src="{{ asset('assets/backend/assets/media/flags/united-states.svg') }}" alt="" /></span></span>--}}
{{--                            </a>--}}
{{--                            <!--begin::Menu sub-->--}}
...
{{--														<img class="rounded-1" src="{{ asset('assets/backend/assets/media/flags/united-states.svg') }}" alt="" />--}}
{{--													</span>English</a>--}}
{{--                                </div>--}}
{{--                                <!--end::Menu item-->--}}
{{--                            </div>--}}
