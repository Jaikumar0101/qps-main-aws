...
<div>
    <div wire:ignore>
        {!!
            ...
            'title'=>trans('Blog Category'),
            'menu'=>[ ['name'=>trans('Blog'),'url'=>'#'],['name'=>trans('Category'),'active'=>true] ]
             ])
        !!}
    </div>
    <!--begin::Card-->
        ...
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <div class="card-action-element flex">
                    ...
                    <a href="{{ route('admin::blog:category.add') }}" wire:navigate  class="btn btn-primary me-2">
