...
<div>
    <div wire:ignore>
        {!!
            ...
            'title'=>trans('Post Collection List'),
            'menu'=>[ ['name'=>trans('Post Collection'),'url'=>'#'],['name'=>trans('List'),'active'=>true] ]
             ])
        !!}
    </div>
    <!--begin::Card-->
        ...
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <div class="card-action-element flex">
                    ...
                    <a href="{{ route('admin::post-collection:add') }}"  wire:navigate class="btn btn-primary me-2">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item"
                                           wire:navigate
                                           href="{{ route('admin::post-collection:edit',['collection_id'=>$item->id]) }}"
                                        >
                                            Edit
                                        </a>
                                    </li>
