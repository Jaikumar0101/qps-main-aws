@section('title','Grouping | Cities')
<div>
    <div wire:ignore>
        {!!
            AdminBreadCrumb::Load([
            'title'=>trans('City Table'),
            'menu'=>[ ['name'=>trans('Grouping')],['name'=>trans('Address')],['name'=>trans('Cities'),'active'=>true] ]
             ])
        !!}
    </div>
    <!--begin::Card-->
    <div class="card">
        ...
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <div class="card-action-element flex">
                    ...
                    <a href="javascript:void(0)"  wire:dirty.attr="disabled" wire:click.prevent="OpenAddEditModal" class="btn btn-primary me-2">
                        <i class="fa fa-plus me-2"></i> Add New City
                    </a>
                    <!--end::Add user-->
                    <div class="btn-group ">
            ...
            <div class="col-12 col-md-5 col-lg-3 mt-2">
                <x-forms.select2 wire:model.live="state_id">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content rounded">
                <div class="modal-header">
                    <div>
                        <h5 class="modal-title" id="exampleModalLabel1">{{Arr::has($request,'id')?'Edit':'New'}} City</h5>
                        <p class="small">Here you can edit the details of city</p>
                    </div>
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form class="form" wire:submit.prevent="save">
                        ...
                        <div class="mb-3">
                            ...
                            <!--end::Label-->
                            <x-forms.select2 wire:model.live="request.state_id" dropdownParent="#addEditModal">
                                <option value="">Choose Option</option>
                                @foreach($states as $state)
                                    <option value="{{$state->id}}">{{$state->name ??''}}</option>
                                @endforeach
                            </x-forms.select2>
                            @error('request.state_id') <div class="text-danger small">{{$message ??''}}</div> @enderror
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <!--begin::Col-->
