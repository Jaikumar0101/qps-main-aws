@section('title','Grouping | States')
<div>
    <div wire:ignore>
        {!!
            AdminBreadCrumb::Load([
                'title'=>trans('State Table'),
                'menu'=>[ ['name'=>trans('Grouping')],['name'=>trans('Address')],['name'=>trans('States'),'active'=>true] ]
           ])
        !!}
    </div>
    <!--begin::Card-->
    <div class="card">
        ...
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <div class="card-action-element flex">
                    ...
                    <a href="javascript:void(0)"  wire:dirty.attr="disabled" wire:click.prevent="OpenAddEditModal" class="btn btn-primary me-2">
                        <i class="fa fa-plus me-2"></i> Add New State
                    </a>
                    <!--end::Add user-->
                    <div class="btn-group ">
            ...
            <div class="col-12 col-md-5 col-lg-3 mt-2">
                <x-forms.select2 wire:model.live="country_id">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content rounded">
                <div class="modal-header">
                    <div>
                        <h5 class="modal-title" id="exampleModalLabel1">{{Arr::has($request,'id')?'Edit':'New'}} State</h5>
                        <p class="small">Here you can edit the details of state</p>
                    </div>
                    ...
                    <form class="form" wire:submit.prevent="save">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="255"
                                   class="form-control form-control-solid @error('request.name') is-invalid @enderror"
                            />
                        ...
                        <div class="form-group mb-3">
                            ...
                            <!--end::Label-->
                            <x-forms.select2 wire:model.live="request.country_id" dropdownParent="#addEditModal">
                                <option value="">Choose Option</option>
                                @foreach($countries as $country)
                                    <option value="{{$country->id}}">{{$country->name ??''}}</option>
                                @endforeach
                            </x-forms.select2>
                            @error('request.country_id') <div class="text-danger small">{{$message ??''}}</div> @enderror
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="form-group mb-3">
