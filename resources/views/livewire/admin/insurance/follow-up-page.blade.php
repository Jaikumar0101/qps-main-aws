...
<div>
    {!!
          ...
          'title'=>trans('Follow-Up Table'),
          'menu'=>[ ['name'=>trans('Follow-Up'),'url'=>'#'],['name'=>trans('List'),'active'=>true] ]
           ])
      !!}
    <!--begin::Content-->
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-header pb-3">
                    <div>
                        <h5 class="modal-title" id="exampleModalLabel1">{{Arr::has($request,'id')?'Edit':'New'}} Follow-Up</h5>
                        <p class="small">Here you can edit the details of follow-Up</p>
                    </div>
