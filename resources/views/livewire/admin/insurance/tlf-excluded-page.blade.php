@section('title','TLF Excluded')
<div>
    {!!
          AdminBreadCrumb::Load([
          'title'=>trans('TLF Excluded Table'),
          'menu'=>[ ['name'=>trans('TLF Excluded'),'url'=>'#'],['name'=>trans('List'),'active'=>true] ]
           ])
      !!}
    <!--begin::Content-->
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-header pb-3">
                    <div>
                        <h5 class="modal-title" id="exampleModalLabel1">{{Arr::has($request,'id')?'Edit':'New'}} TLF Excluded</h5>
                        <p class="small">Here you can edit the details of TLF excluded</p>
                    </div>
