@section('title','Worked By')
<div>
    {!!
          AdminBreadCrumb::Load([
          'title'=>trans('Worked By Table'),
          'menu'=>[ ['name'=>trans('Worked By'),'url'=>'#'],['name'=>trans('List'),'active'=>true] ]
           ])
      !!}
    <!--begin::Content-->
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-header pb-3">
                    <div>
                        <h5 class="modal-title" id="exampleModalLabel1">{{Arr::has($request,'id')?'Edit':'New'}} Worked By</h5>
                        <p class="small">Here you can edit the details of worked by</p>
                    </div>
