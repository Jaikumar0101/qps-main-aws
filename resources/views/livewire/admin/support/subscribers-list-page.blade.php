@section('title','Others | Subscribers')
<div>
    {!!
          AdminBreadCrumb::Load([
          'title'=>trans('Subscribers'),
          'menu'=>[ ['name'=>trans('Subscribers'),'url'=>'#'],['name'=>trans('List'),'active'=>true] ]
           ])
      !!}
    <!--begin::Content-->
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        ...
                        <tr class="fw-semibold fs-6 text-gray-800 border-bottom border-gray-200">
                            ...
                            <th class="min-w-125px">Newsletter</th>
                        ...
                        @forelse($data as $item)
                            <tr>
                                ...
                                <td>
                                    @if($item->newsletter)
                                        <span class="badge badge-dark">Subscribed</span>
                                    @else
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-header">
                    <div>
                        <h5 class="modal-title" id="exampleModalLabel1">{{Arr::has($request,'id')?'Edit':'New'}} Subscriber</h5>
                        <p class="small">Here you can edit the details of subscriber</p>
                    </div>
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form class="form" wire:submit.prevent="save">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('request.newsletter') is-invalid @enderror" wire:model="request.newsletter">
                                <option value="1">Subscribed</option>
                                <option value="0">Unsubscribed</option>
                            </select>
                            @error('request.newsletter') <div class="invalid-feedback">{{$message ??''}}</div> @enderror
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="mb-3">
