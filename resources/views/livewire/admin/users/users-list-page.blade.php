...
<div>
    <div wire:ignore>
        {!!
            ...
            'title'=>trans('Users Table'),
            'menu'=>[ ['name'=>trans('Users')],['name'=>trans('List'),'active'=>true] ],
             ])
        !!}
    </div>
    <!--begin::Content-->
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true" style="">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('admin::users:edit',['user_id'=>$item->id]) }}" wire:navigate class="menu-link px-3">
                                                Edit
                                            </a>
                                        </div>
                                        <!--end::Menu item-->
